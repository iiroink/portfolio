...
class Käyttöliittymä:
  def __init__(self):
    ...
    self.__labelA = Label(self.__pääikkuna, text="A", borderwidth=2, relief=GROOVE)
    ...
    self.__korkealabel = Label(self.__pääikkuna, text="korkea", borderwidth=2)
    self.__korkealabel.grid(row=0, column=0, rowspan=3, sticky=N+S)

    self.__leveälabel = Label(self.__pääikkuna, text="leveä", borderwidth=2)
    self.__leveälabel.grid(row=0, column=1, columnspan=2, sticky=E+W)

    self.__lopetusnappi = Button(self.__pääikkuna, text="lopeta mut", command=self.lopeta)
