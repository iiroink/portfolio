...
*
* Description: Modified template class for a single tile on 2048 board.
*
* Modifications: - Add get_value method.
*                - Add score counting to move method.
*                - Add set_zero method.
*
* */
...
public:
    ...
    bool move(Coords direction, int goal_val, int& score);
    ...
    // Returns the value in the tile.
    int get_value();

    // Sets the value of the tile to zero.
    void set_zero();
